...
using System.Data;
using System.Text;
using TelecommunicationWebApp.API;
...
builder.Services.AddTransient<TelecommunicationContext>(x => new TelecommunicationContext(settings.ConnectionString));
...
builder.Services.AddTransient<IApplicationActorProvider>(x =>
{
    ...
    var context = x.GetService<TelecommunicationContext>();
